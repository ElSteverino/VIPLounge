...
protocol VIPLoungePresentationLogic {
    
    func presentVIPCode( response: VIPLounge.Update.Response )
...
class VIPLoungePresenter: VIPLoungePresentationLogic {
    
    weak var viewer: VIPLoungeDisplayLogic?

    
    // MARK: - UseCase: Do Something
    /*====================================================================================================================================*/
    
    func presentVIPCode( response: VIPLounge.Update.Response ) {

        let viewModel = VIPLounge.Update.ViewModel( vipCode: response.vipCode )
        viewer?.displayVIPCodeView( viewModel: viewModel )
